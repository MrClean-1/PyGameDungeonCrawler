...
from data.direction import find_direction, random_direction
...
class SkullBadGuy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.sheet = spritesheet.SpriteSheet("data/skullbadguy.png")
    ...
    def bone_throw(self):
        if self.bone_counter == self.bone_timer:
            ...
            self.bone_timer = random.randint(50, 70)
            self.bone = Projectile('data/bone.gif', self.bone_throw_direction, True, 32)
